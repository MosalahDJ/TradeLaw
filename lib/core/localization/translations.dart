...
class Messages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    ...
    "get_location": "Get Location",
      ...
      'enable_gps_message': "Please enable GPS to get your current location",
      ...
      'account_settings_desc': "Manage your account and personal information",
    ...
    "get_location": "الحصول على الموقع",
      ...
      "please_login_again_to_delete": "الرجاء إعادة تسجيل الدخول لحذف حسابك",
      ...
      'contact_support_if_error': 'إذا كنت تعتقد أن هناك خطأ، تواصل مع الدعم',
      'ok': 'حسناً',
      ...
      'send': 'إرسال',
      'model_loading': 'النموذج قيد التحميل، يرجى المحاولة مرة أخرى بعد قليل',
      ...
      'enable_permission_settings': "يرجى تفعيل إذن الموقع من إعدادات التطبيق",
      ...
      'upcoming_feature_desc': 'هذه الميزة قيد التطوير وستكون متاحة قريبًا.',
